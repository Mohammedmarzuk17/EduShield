📘 EduShield – Browser Extension & Blocklist Collector
EduShield is a powerful Chrome extension designed to protect users from phishing websites and unverified educational institutions. It combines automated blocklist updates with intelligent content analysis to provide real-time safety and verification features.
...
This repository handles automated collection of blocklists from the sources mentioned above. Blocklists are updated daily at 1:00 UTC, ensuring that the extension always works with the latest threat intelligence.
